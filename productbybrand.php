        ...
        <div class="container">
          <div class="banner_content d-md-flex justify-content-between align-items-center">
            ...
            <?php 
              ...
              ?>
              <h2>Danh mục: <?php echo $result_name['brandName']; ?></h2>
              <p>Best Service, Right Time, Right People – Dịch vụ tốt nhất, Đúng lúc, Đúng người</p>
            </div>
            <div class="page_link">
              <a href="index.php">Trang chủ</a>
              <a>Thương hiệu</a>
              <a style="color: #71cd14;"><?php echo $result_name['brandName']; ?></a>
              <?php 
                  }
                }
              ?>
                ...
                <div class="widgets_inner">
                  <div class="range_item">
                    <div id="slider-range"></div>
                      ...
                      <input type="hidden" name="brand" value="<?php echo $_GET['brandid']; ?>">
